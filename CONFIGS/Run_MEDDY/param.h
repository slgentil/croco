...
#  elif RESOLUTION == 512
!     parameter (LLm0=512,  MMm0=512,  N=120)
...
#ifdef GO_MEDDY
!
! variables for GO experiment
!

      integer :: iind,jind
      real(8) ::  zmid,Nfreq2, Nfreq, distance2
      real(8),dimension(GLOBAL_2D_ARRAY,N) :: rhopr
      real(8),dimension(GLOBAL_2D_ARRAY,N) :: rich
      real(8),dimension(N) :: Nfreq2_bk
      real(8),dimension(GLOBAL_2D_ARRAY,N) :: Nfreq2_tot
