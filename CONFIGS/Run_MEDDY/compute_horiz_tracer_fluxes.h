...
#  endif
#  if (defined DIAG_SPEC && !defined PREDICTOR)
              gradC4(i,j)=0.5*(FX(i+1,j)+FX(i,j))
#  endif
            enddo
          enddo             !--> discard FX
          do j=Jstr,Jend
...
#   endif
#   if (defined DIAG_SPEC && !defined PREDICTOR)
              FXC(i,j)=0.5*( t(i,j,k,nadv,itrc)+t(i-1,j,k,nadv,itrc)
     &                     -0.333333333333*(gradC4(i,j)-gradC4(i-1,j))
     &                                                )*Huon(i,j,k)
#   endif
            enddo
          enddo            !--> discard grad
...
#  endif
#  if (defined DIAG_SPEC && !defined PREDICTOR)
              gradC4(i,j)=0.5*(FE(i,j+1)+FE(i,j))
#  endif
            enddo
          enddo            !--> discard FE
          do j=Jstr,Jend+1
...
#  endif
#  if (defined DIAG_SPEC && !defined PREDICTOR)
              FEC(i,j)=0.5*( t(i,j,k,nadv,itrc)+t(i,j-1,k,nadv,itrc)
     &                     -0.333333333333*(gradC4(i,j)-gradC4(i,j-1))
     &                                               )*Hvom(i,j,k)
#  endif
            enddo
          enddo            !--> discard grad
