...
"""
  script python pour lancer une simulation en plusieurs chaînages sur datarmor
 
  [syntaxe] : chain_datarmor.py workdir nbchain elaptim resolution jobname restart
      arguments:
          ...
          restart : 0=from scratch, 1=restart
"""
...
if  len(sys.argv) < 7 :
    ...
    print 'resolution : resolution 2 pour 1/2 degré, 4 ou 8'
