...
#ifdef DIAG_SPEC
      real TT(GLOBAL_2D_ARRAY,N,NT)
      real TXadvC(GLOBAL_2D_ARRAY,N,NT)
      real TYadvC(GLOBAL_2D_ARRAY,N,NT)
      real RHOrate(GLOBAL_2D_ARRAY,N)
#  ifdef NONLIN_EOS     
      real rho_bak(GLOBAL_2D_ARRAY,N,2)
#  endif     
#endif
#if defined DIAG_SPEC || defined DIAG_SPEC_KT
      real TTmoy(GLOBAL_2D_ARRAY,N,NT)
#endif
!
...
# ifdef DIAG_SPEC
     ...
     &       /diag_TXadvC/TXadvC  
     &       /diag_TYadvC/TYadvC
     &       /diag_RHOrate/RHOrate
#ifdef NONLIN_EOS     
     &       /diag_rho_bak/rho_bak
#endif     
# endif
# if defined DIAG_SPEC || defined DIAG_SPEC_KT
     &       /diag_TTmoy/TTmoy 
...
# endif
#ifdef DIAG_SPEC
      real MXadvC(GLOBAL_2D_ARRAY,N,2)
      real MYadvC(GLOBAL_2D_ARRAY,N,2)
      real MV(GLOBAL_2D_ARRAY,N,2)
#endif
#if defined DIAG_SPEC || defined DIAG_SPEC_KT
      real MVmoy(GLOBAL_2D_ARRAY,N,2)
#endif
# ifdef MRL_WCI
