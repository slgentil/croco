...
#  elif defined MOZ                            
#    if RESOLUTION == 128                      
       parameter (LLm0=128,  MMm0=128,  N=60)  ! Mozambique                   
#    elif RESOLUTION == 256                      
       parameter (LLm0=256,  MMm0=256,  N=120)  ! Mozambique
#    elif RESOLUTION == 512
       parameter (LLm0=512,  MMm0=512,  N=240)  
#    elif RESOLUTION == 768
       parameter (LLm0=768,  MMm0=768,  N=320)  
...
#    elif RESOLUTION == 1024 
!      parameter (NP_XI=2 , NP_ETA=4, NNODES=NP_XI*NP_ETA)        ! 64 cores
!      parameter (NP_XI=4 , NP_ETA=4, NNODES=NP_XI*NP_ETA)        ! 64 cores
!      parameter (NP_XI=4 , NP_ETA=8, NNODES=NP_XI*NP_ETA)        ! 64 cores
...
#    elif RESOLUTION == 1620 
       parameter (NP_XI=10, NP_ETA=47, NNODES=NP_XI*NP_ETA)
!      parameter (NP_XI=54, NP_ETA=10, NNODES=NP_XI*NP_ETA)
!      parameter (NP_XI=30, NP_ETA=20, NNODES=NP_XI*NP_ETA)
!      parameter (NP_XI=36, NP_ETA=20, NNODES=NP_XI*NP_ETA)
!      parameter (NP_XI=18, NP_ETA=47, NNODES=NP_XI*NP_ETA)
