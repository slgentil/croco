...
#else 
!     parameter (LLm0=128,  MMm0=360,  N=24)      !  8 km
      parameter (LLm0=128,  MMm0=360,  N=26)      !  8 km
#endif                          
#  elif RESOLUTION == 4
#ifdef Y_STRETCH_GRID
...
#      else
! 2016 procs (63 noeuds de 32 procs sur fermi)
!       parameter (NP_XI=32, NP_ETA=63,  NNODES=NP_XI*NP_ETA)
! 1008 procs (63 noeuds de 32 procs sur fermi)
!       parameter (NP_XI=16, NP_ETA=63,  NNODES=NP_XI*NP_ETA)
! 64x126 blocks - 192 procs caparmor specific
!      parameter (NP_XI=16, NP_ETA=12,  NNODES=NP_XI*NP_ETA)
! 1984 procs (62 noeuds de 32 procs sur fermi)
!       parameter (NP_XI=32, NP_ETA=62,  NNODES=NP_XI*NP_ETA)
...
#  else
!
! 8064 procs (252 noeuds de 32 procs sur fermi)
!       parameter (NP_XI=64, NP_ETA=126,  NNODES=NP_XI*NP_ETA)
! 4032 procs (126 noeuds de 32 procs sur fermi)
!      parameter (NP_XI=32, NP_ETA=128,  NNODES=NP_XI*NP_ETA)
! 7680 procs (240 noeuds de 32 procs sur fermi)
!       parameter (NP_XI=64, NP_ETA=120,  NNODES=NP_XI*NP_ETA)
! 15360 procs (960 noeuds x 16 procs sur fermi)
!       parameter (NP_XI=32, NP_ETA=480,  NNODES=NP_XI*NP_ETA)     ! fermi
! 30720 procs (960 noeuds x 32 procs sur fermi)
!       parameter (NP_XI=64, NP_ETA=480,  NNODES=NP_XI*NP_ETA)
! 23040 procs
!       parameter (NP_XI=64, NP_ETA=360,  NNODES=NP_XI*NP_ETA)
       parameter (NP_XI=16, NP_ETA=60,  NNODES=NP_XI*NP_ETA)   ! datarmor   
